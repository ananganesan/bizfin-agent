...
# Deployment script for bizfin-agent on Hetzner server
...
# Skip IP check - we're already on the right server if we can SSH in
echo -e "${GREEN}✅ Connected to Hetzner server${NC}"
echo ""
